...
def prior():
    ...
    lamda = [m_break, alpha_1, alpha_2, gamma_low, eta_low, gamma_high, eta_high, A, m_min, eta_min, m_max, eta_max, beta_1, beta_2, sep, H0, Om0, w, kappa, alpha_chi, beta_chi, mix_tilt, sig_tilt]
    return lamda
    
    
def get_guess_args(num_chains):
    g = lambda guess: guess * xp.ones(num_chains)
    guess_args = {'m_break': 5.0, 'alpha_1': -3.28, 'alpha_2': -1.15, 'gamma_low': 2.4, 'eta_low': 10.0, 'gamma_high': 5.5, 'eta_high': 10.0, 'A': 0.9, 'm_min': 0.8, 'eta_min': 20.0, 'm_max': 70.0, 'eta_max': 3.0, 'beta_1': 0.41, 'beta_2': 4.83, 'kappa': 2.7, 'alpha_chi': 2.0, 'beta_chi': 2.0, 'mix_tilt': 0.5, 'sig_tilt': 1.0}

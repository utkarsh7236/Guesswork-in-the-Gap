...
def get_guess_args(num_chains):
    ...
    guess_args = {'alpha_1': -3.28, 'alpha_2': -1.15, 'm_break': 5.0, 'mu_peak': 35.0, 'sigma_peak': 40.0, 'mixture': 0.1, 'beta_1': 0.41, 'beta_2': 4.83, 'kappa': 0.0, 'mu_chi1': 0.1, 'sig_chi1': 2.0, 'mix_tilt1': 0.5, 'sig_tilt1': 1.0, 'mu_chi2': 0.1, 'sig_chi2': 2.0, 'mix_tilt2': 0.5, 'sig_tilt2': 1.0}

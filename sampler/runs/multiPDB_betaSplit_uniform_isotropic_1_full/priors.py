...
def get_guess_args(num_chains):
    ...
    guess_args = {'m_break': 5.0, 'alpha_1': -3.28, 'alpha_2': -1.15, 'gamma_low': 2.4, 'gamma_high': 5.5, 'A': 0.9, 'm_min': 1.1, 'eta_min': 20.0, 'm_max': 70.0, 'eta_max': 3.0, 'mu_peak1': 9.0, 'sig_peak1': 2.0, 'mu_peak2': 35.0, 'sig_peak2': 5.0, 'beta_1': 0.41, 'beta_2': 4.83, 'kappa': 2.7}

...
def ln_prob_m_det(theta, lamda):
    ...
    (m_break, alpha_1, alpha_2, gamma_low, eta_low, gamma_high, eta_high, A, m_min, eta_min, m_max, eta_max, beta_1, beta_2, sep, H0, Om0, w, kappa) = lamda
    pairing_func = lambda m1, m2: beta_split(m1, m2, beta_1, beta_2, sep)
    mass_prob_func = lambda m: pdb(m,m_break, alpha_1, alpha_2, gamma_low, eta_low, gamma_high, eta_high, A, m_min, eta_min, m_max, eta_max)
    prob_mass1_source = mass_prob_func(mass1_source)
    prob_mass2_source = 1/99 # Uniform distribution between 1 and 100
...
def ln_prob_spin(theta, lamda):
    mass1_source, mass2_source, z, a1, costilt1, a2, costilt2 = theta
    (m_break, alpha_1, alpha_2, gamma_low, eta_low, gamma_high, eta_high, A, m_min, eta_min, m_max, eta_max, beta_1, beta_2, sep, H0, Om0, w, kappa) = lamda
    spin_prob_func = uniform_isotropic(mass1_source, mass2_source, a1, costilt1, a2, costilt2, )

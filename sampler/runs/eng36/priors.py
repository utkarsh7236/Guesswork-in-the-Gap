...
def get_guess_args(num_chains):
    ...
    guess_args = {'alpha_1': -3.28, 'mu_peak': 35.0, 'sigma_peak': 10.0, 'mixture': 0.1, 'beta_1': 0.41, 'beta_2': 4.83, 'kappa': 2.7, 'alpha_chi': 2.0, 'beta_chi': 2.0, 'mix_tilt': 0.5, 'sig_tilt': 1.0}

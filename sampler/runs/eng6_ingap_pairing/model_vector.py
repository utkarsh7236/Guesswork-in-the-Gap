...
def ln_prob_m_det(theta, lamda):
    ...
    (m_break, alpha_1, alpha_2, gamma_low, eta_low, gamma_high, eta_high, A, m_min, eta_min, m_max, eta_max, mu_peak1, sig_peak1, peak_constant1, mu_peak2, sig_peak2, peak_constant2, mu_peak_NS, sig_peak_NS, peak_constant_NS, model_min, model_max, beta_1, beta_2, beta_gap, sep, H0, Om0, w, kappa, mu_chi, sig_chi, mix_tilt, sig_tilt) = lamda
    redshift = z
...
def ln_prob_spin(theta, lamda):
    ...
    spin_prob_func = truncnorm_gwtc3(mass1_source, mass2_source, a1, costilt1, a2, costilt2, mu_chi, sig_chi, mix_tilt, sig_tilt)

...
def prior():
    ...
    lamda = [alpha_1, alpha_2, m_break, mu_peak, sigma_peak, mixture, beta_1, H0, Om0, w, kappa, alpha_chi, beta_chi, mix_tilt, sig_tilt]
    return lamda
    
    
def get_guess_args(num_chains):
    g = lambda guess: guess * xp.ones(num_chains)
    guess_args = {'alpha_1': -3.28, 'alpha_2': -1.15, 'm_break': 5.0, 'mu_peak': 30.0, 'sigma_peak': 5.0, 'mixture': 0.1, 'beta_1': 0.41, 'kappa': 2.7, 'alpha_chi': 2.0, 'beta_chi': 2.0, 'mix_tilt': 0.5, 'sig_tilt': 1.0}

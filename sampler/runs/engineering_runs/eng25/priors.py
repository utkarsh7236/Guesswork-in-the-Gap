...
def prior():
    ...
    lamda = [alpha_1, alpha_2, m_break, mu_peak, sigma_peak, mixture, beta_1, beta_2, sep, H0, Om0, w, kappa]
    return lamda
    
    
def get_guess_args(num_chains):
    g = lambda guess: guess * xp.ones(num_chains)
    guess_args = {'alpha_1': -3.28, 'alpha_2': -1.15, 'm_break': 5.0, 'mu_peak': 35.0, 'sigma_peak': 40.0, 'mixture': 0.1, 'beta_1': 0.41, 'beta_2': 4.83, 'kappa': 2.7}

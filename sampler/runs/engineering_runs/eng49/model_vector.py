...
def ln_prob_m_det(theta, lamda):
    ...
    (alpha_1, mu_peak, sigma_peak, mixture, model_min, beta_1, H0, Om0, w, kappa, alpha_chi, beta_chi, mix_tilt, sig_tilt) = lamda
    pairing_func = lambda m1, m2: beta(m1, m2, beta_1)
    ...
    ln_prob_joint_mass_source = xp.log(prob_mass1_source) + xp.log(pairing_func(mass1_source, mass2_source))

...
def ln_prob_m_det(theta, lamda):
    ...
    (alpha_1, alpha_2, m_break, mu_peak, sigma_peak, mixture, beta_1, beta_2, sep, H0, Om0, w, kappa, mu_chi, sig_chi, mix_tilt, sig_tilt, a_max, a_min, costilt_max, costilt_min) = lamda

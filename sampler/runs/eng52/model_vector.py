...
def ln_prob_m_det(theta, lamda):
    ...
    (m_break, alpha_1, alpha_2, gamma_low, eta_low, gamma_high, eta_high, A, m_min, eta_min, m_max, eta_max, beta_1, beta_2, sep, H0, Om0, w, kappa, alpha_chi, beta_chi, mix_tilt, sig_tilt) = lamda

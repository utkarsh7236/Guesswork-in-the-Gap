...
if __name__ == "__main__":
    folder_path = "../../../sampler/runs/pdb_uniform_betaSplit_uniform_isotropic_1_full/"
    ...
    conversion_dict = json.load(open("../../conversion_dictionaries/pdb_uniform_betaSplit_uniform_isotropic.txt"))
    ...
    print(converted_posterior_samples.keys())

...
if __name__ == "__main__":
    folder_path = "../../../sampler/runs/pdbNG_betaSplit_brokenG_1_full_sig_peak1_large/"
    ...
    conversion_dict = json.load(open("../../conversion_dictionaries/pdbNG_betaSplit_brokenG_sig_peak1_large.txt"))

...
if __name__ == "__main__":
    folder_path = "../../sampler/runs/pdbNG_betaSplitSmooth_brokenG_1_full/"
    ...
    conversion_dict = json.load(open("../conversion_dictionaries/pdbNG_betaSplitSmooth_brokenG.txt"))
    ...
    req_lst = ["m_break", "alpha_1", "alpha_2", 

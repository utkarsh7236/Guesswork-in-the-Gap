...
if __name__ == "__main__":
    folder_path = "../../sampler/runs/multiPDB_betaSplit3_brokenG_1_full/"
    ...
    conversion_dict = json.load(open("../conversion_dictionaries/multiPDB_betaSplit3_brokenG.txt"))
    ...
    replace_v1 = lambda name, val: val*np.ones(merged_posterior_samples[name].shape)
    ...
    for key, val in pop_dict.items():
        ...
        merged_posterior_samples[key] = replace_v1(key, val)

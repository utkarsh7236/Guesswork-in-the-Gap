...
if __name__ == "__main__":
    folder_path = "../../sampler/runs/multiPDB_betaSplitSmooth_brokenG_1_full/"
    ...
    conversion_dict = json.load(open("../conversion_dictionaries/multiPDB_betaSplitSmooth_brokenG.txt"))
